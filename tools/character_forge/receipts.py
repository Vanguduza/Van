...
def packaging_receipt(*, candidate: Path, stage: str, authoring_tool: str, authoring_version: str, rive_file_id: str, rive_revision: str, svg_sha: str, contract_sha: str, artist: str, source_project: str, source_tree_sha256: str, source_file_count: int, notes: str = "") -> dict[str, Any]:
