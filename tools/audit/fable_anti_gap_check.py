...
CHECKS: list[Check] = [
    ...
    ("GAP-F-013", "router gates then selects the real sherpa engine", "android/app/src/main/java/com/dial/van/voice/LocalTtsRouter.kt", r"engines\[TtsEngineKind\.SHERPA_ONNX\][\s\S]{0,320}TtsSelection\.Engine\(\s*TtsEngineKind\.SHERPA_ONNX", True, 1),
    ...
    ("GAP-F-026", "critical durable routing selects Temporal", "backend/van_gateway/automation/router.py", r"if request\.critical_durable:[\s\S]{0,280}medium=ExecutionMedium\.TEMPORAL", True, 1),
