...
ROOT=Path(__file__).resolve().parents[2]; SOURCE=ROOT/"visual-authority"/"rive"/"van_runtime.riv"; SHIPPED=ROOT/"android"/"app"/"src"/"main"/"assets"/"van.riv"; RELEASE=ROOT/"visual-authority"/"rive"/"manifest.json"; ACCEPTANCE=ROOT/"docs"/"character_forge"/"ACCEPTANCE.yaml"; CONTRACT=ROOT/"visual-authority"/"rive_contract.json"; IDENTITY=ROOT/"docs"/"VAN_CHARACTER_VISUAL_IDENTITY.md"; MATRIX=ROOT/"docs"/"VAN_VISUAL_ACCEPTANCE_MATRIX.md"
