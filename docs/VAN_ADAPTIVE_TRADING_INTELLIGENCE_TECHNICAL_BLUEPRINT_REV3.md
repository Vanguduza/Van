...
| D7 | Validation gates: deflated Sharpe > 0, PBO ≤ 0.10 (CPCV), a one-switch decision-time leakage test, cost stress at 2×, LEAN reproduction for Tier-A. | A.7 | Same as Rev 2 §26, now with leakage switch |
